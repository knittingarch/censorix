...
# content paragraphs
content1 = "It's important to me that you're happy. Maybe we got a few little happy bushes here, just covered with snow. It's all a game of angles. Anytime you learn something your time and energy are not wasted. You can do anything your heart can imagine.
...
content2 = "Steve wants reflections, so let's give him reflections. A big strong tree needs big strong roots. Imagination is the key to painting.
...
content4 = "I get carried away with this brush cleaning. Isn't that fantastic? You can just push a little tree out of your brush like that. Making all those little fluffies that live in the clouds. And just raise cain. The first step to doing anything is to believe you can do it. See it finished in your mind before you ever start. You can create anything that makes you happy.
...
content5 = "Maybe there's a little something happening right here. Let's build some happy little clouds up here. You can do it.
...
# create 5 posts with content, categories, and tags
Post.create!(title: "Post #1", content: content1, categories: [category1], tags: [tag1, tag2], featured: true)

Post.create!(title: "Post #2", content: content2, categories: [category1], tags: [tag1, tag2])

Post.create!(title: "Post #3", content: content3, categories: [category2], tags: [tag5])

Post.create!(title: "Post #4", content: content4, categories: [category2], tags: [tag4])

Post.create!(title: "Post #5", content: content5, categories: [category3], tags: [tag3])
